...
import com.xiong.maker.template.FileFilter;
import com.xiong.maker.meta.Meta;
import com.xiong.maker.meta.enums.FileGenerateTypeEnum;
import com.xiong.maker.meta.enums.FileTypeEnum;
import com.xiong.maker.template.enums.FileFilterRangeEnum;
import com.xiong.maker.template.enums.FileFilterRuleEnum;
import com.xiong.maker.template.model.*;
...
//        String sourceRootPath = templatePath + File.separator + FileUtil.getLastPathEle(Paths.get(originProjectPath)).toString();
     ...
     * 制作文件模板
     *
     * @param templateMakerModelConfig //挖坑配置类
     * @param sourceRootPath
     * @param inputFile //过滤后的单个文件
    ...
    private static Meta.FileConfig.FileInfo makeFileTemplate(TemplateMakerModelConfig templateMakerModelConfig,
        ...
        String fileOutputAbsolutePath = fileInputAbsolutePath + ".ftl";//挖坑文件生成路路径

        // 文件输入输出相对路径（用于生成配置）
        String fileInputPath = fileInputAbsolutePath.replace(sourceRootPath + "/", "");
        String fileOutputPath = fileInputPath + ".ftl";//配置文件生成路径
