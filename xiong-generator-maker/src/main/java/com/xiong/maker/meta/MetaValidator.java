...
import com.xiong.maker.meta.enums.ModelTypeEnum;
...
public class MetaValidator {
    ...
    public static void validAndFillMetaRoot(Meta meta) {
        ...
        String author = StrUtil.emptyToDefault(meta.getAuthor(), "xiong");
        String basePackage = StrUtil.blankToDefault(meta.getBasePackage(), "com.xiong");
